...
{
  return `Removes a pretender (both the claim and the file) from the list received when using the \`${pretendersCommand}\` command, i.e. \`${config.prefix}${module.exports.getReadableCommand()} 1\`.`;
};
