...
const key = "supplies";
const name = "Supply Percentage";
const expectedType = "IntRange";
const expectedValue = [50, 300];
const cue = `**${name}:** Any integer between ${expectedValue[0]} and ${expectedValue[1]} (normally 100, indicates the percentage of supplies earned).`;
