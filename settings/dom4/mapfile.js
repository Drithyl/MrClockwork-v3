...
const cue = `**${name}:** Use \`${config.prefix}maps dom4 [chosen server name]\` (without brackets) to receive a list of the maps available on the server you chose. You can respond one of the following:\n\n\t${mapfileInputInfo}\n\t${randomMapInputInfo}`;
